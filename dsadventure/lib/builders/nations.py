    ...
    for i in o:
        ...
        for j in s:
            if i != j:
                ...
                i.diplomacy[j.name]['stance'] = set_treaties(
                    i.diplomacy[j.name]['favor'])
...
def place_feature(world, a, o, event):
    '''
    features are placed randomly in a nation.
    placed in the o nation. o is the object or recipient of the event.
    '''
    for n in o:
